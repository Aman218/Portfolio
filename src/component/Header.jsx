          ...
          <div id='container' className="text-white">
            ...
            <div id='left-container' className='w-[50%]'>
              ...
              <div id='menu-icon' className='relative text-end'>
                ...
                {!flag &&
                  <div className='absolute flex flex-col items-center justify-center z-100 right-0 w-[90vw] h-[200px] bg-[#0C0D1E] rounded-2xl'>
                    <Link to='/'>
                    ...
                    <div id='nav3' className='flex items-center gap-1 font-[500] '>
                      <ImportantDevicesIcon style={{ fontSize: 15 }} />
                      <span>Projects</span>
                    </div>
                    <div id='nav4' className='flex items-center gap-1 font-[500] '>
                      <NewspaperIcon style={{ fontSize: 15 }} />
                      <span>Resume</span>
                    </div>
                  </div>
